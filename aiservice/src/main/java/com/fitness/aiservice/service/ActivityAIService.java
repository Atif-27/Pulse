...
public class ActivityAIService {
    ...
    public Recommendation generateRecommendation(Activity activity){
        ...
        String aiResponse= genAiService.getAnswer(prompt);
    ...
    public Recommendation processAiResponse(Activity activity, String aiResponse){
        try{
            ...
            JsonNode improvementsNode= responseJson.path("improvements");
            List<String> improvements= extractImprovements(improvementsNode);
            // Parsing Suggestions
            JsonNode suggestionsNode= responseJson.path("suggestions");
            List<String> suggestions = extractSuggestions(suggestionsNode);
            // Parsing Safety
            JsonNode safetyNode= responseJson.path("safety");
    ...
    private List<String> extractSafety(JsonNode safetyNode) {
        ...
        return safety.isEmpty()? Collections.singletonList("No specific safety measure provided") : safety;
    }
    ...
    private @NonNull String createPromptFromActivity(Activity activity) {
